...
class Song {
  ...
  // ---------------- YoutubeExplode Video se Song banana ----------------
  // Search results ya video details se seedha Song object mil jaata hai.

  factory Song.fromYtResult(yt.Video video) {
    // Sabse best quality wali thumbnail utha lo
